...
public class String02LongString {
	...
	public static void main(String[] args) {
		...
		String str = "[지디넷코리아]"
			...
			// 문제 1. 위의 str 데이터 중 "HTML5"라는 단어가 몇 번 노출되는지
			// 노출 횟수를 resultNum이라는 배열명으로 저장하여 출력
			int count = 0;
			for (String string2 : string) {
				if (string2.equals("HTML5")) {
					count++;
				}
			}
			...
			String tempString = "우리는 세종대왕이 만든 빛나는 문화유산인 한글을 갖고있다.";
			...
			// 문제 2. 위의 str 데이터를 모두 역순(space기준)으로 resultStr 변수 저장하여 출력
